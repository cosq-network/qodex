...
* add professional TUI interaction workflows ([5a1a819](https://github.com/cosq-network/qodex/commit/5a1a819402220236db3f421fc4f54ea7b52df7df))
...
* add TUI slash commands and MCP diagnostics ([1c516ef](https://github.com/cosq-network/qodex/commit/1c516ef790b89b917199f2356c1d07a4f20a28f8))
...
* harden agent runtime and git workflows ([ba30877](https://github.com/cosq-network/qodex/commit/ba30877018287f908f0fbe4596cd124d97daa188))
* harden model downloads, add deterministic progress bar, and configurable llama.cpp startup ([1f0b820](https://github.com/cosq-network/qodex/commit/1f0b820b3837a2a5281f5aa1f5b86aec7d94eb40))
...
* polish terminal UI experience ([df89214](https://github.com/cosq-network/qodex/commit/df892144a67e6a3821413b01b3abeef4873139db))
...
* harden Windows compatibility and dependency metadata ([f583579](https://github.com/cosq-network/qodex/commit/f583579c56be908f2ca7dec784550ab2e87f92c0))
* make codebase lint-clean and harden resource handling ([660b3d7](https://github.com/cosq-network/qodex/commit/660b3d7abc81bb8e34ff2c456d5de9302f68b3b0))
